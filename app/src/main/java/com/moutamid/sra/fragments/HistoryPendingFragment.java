...
import com.moutamid.sra.databinding.FragmentHistoryPendingBinding;
...
public class HistoryPendingFragment extends Fragment {
    FragmentHistoryPendingBinding binding;
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentHistoryPendingBinding.inflate(inflater, container, false);
