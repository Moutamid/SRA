...
import com.moutamid.sra.databinding.FragmentHistoryCanceledBinding;
...
public class HistoryCanceledFragment extends Fragment {
    FragmentHistoryCanceledBinding binding;
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentHistoryCanceledBinding.inflate(inflater, container, false);
